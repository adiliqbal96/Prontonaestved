...
const menuData = [
  // PIZZA
  { id: 1, name: "1. Tomat · Ost", price: 80, category: "pizza", ingredients: ["Tomat", "Ost"], image: "https://images.unsplash.com/photo-1604068549290-dea0e4a305ca?q=80&w=600&auto=format&fit=crop" },
  { id: 2, name: "2. Tomat · Ost · Skinke", price: 86, category: "pizza", ingredients: ["Tomat", "Ost", "Skinke"], image: "https://images.unsplash.com/photo-1552539618-7eec9b4d1b09?q=80&w=600&auto=format&fit=crop" },
  ...
  { id: 4, name: "4. Tomat · Ost · Skinke · Bacon · Peberfrugt", price: 90, category: "pizza", ingredients: ["Tomat", "Ost", "Skinke", "Bacon", "Peberfrugt"], image: "https://images.unsplash.com/photo-1528137871618-79d2761e3fd5?q=80&w=600&auto=format&fit=crop" },
  { id: 5, name: "5. Tomat · Ost · Skinke · Champignon", price: 90, category: "pizza", ingredients: ["Tomat", "Ost", "Skinke", "Champignon"], image: "https://images.unsplash.com/photo-1534308983496-4fabb1a015ee?q=80&w=600&auto=format&fit=crop" },
  { id: 6, name: "6. Tomat · Ost · Pepperoni · Oliven · Løg", price: 90, category: "pizza", ingredients: ["Tomat", "Ost", "Pepperoni", "Oliven", "Løg"], image: "https://images.unsplash.com/photo-1628840042765-356cda07504e?q=80&w=600&auto=format&fit=crop" },
  ...
  { id: 9, name: "9. Tomat · Ost · Tun · Rejer", price: 90, category: "pizza", ingredients: ["Tomat", "Ost", "Tun", "Rejer"], image: "https://images.unsplash.com/photo-1513104890138-7c749659a591?q=80&w=600&auto=format&fit=crop" },
  ...
  { id: 12, name: "12. Tomat · Ost · Laks · Friske tomater · Pesto · Kapers", price: 98, category: "pizza", ingredients: ["Tomat", "Ost", "Laks", "Friske tomater", "Pesto", "Kapers"], image: "https://images.unsplash.com/photo-1574484284002-952d92456975?q=80&w=600&auto=format&fit=crop" },
  { id: 13, name: "13. Tomat · Ost · Kalkun · Champignon · Chili", price: 96, category: "pizza", ingredients: ["Tomat", "Ost", "Kalkun", "Champignon", "Chili"], image: "https://images.unsplash.com/photo-1506084868230-bb9d95c24759?q=80&w=600&auto=format&fit=crop" },
  ...
  { id: 22, name: "22. Tomat · Ost · Bresaola · Gorgonzola · Rucola", price: 103, category: "pizza", ingredients: ["Tomat", "Ost", "Bresaola", "Gorgonzola", "Rucola"], image: "https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?q=80&w=600&auto=format&fit=crop" },
  ...
  { id: 25, name: "25. Tomat · Ost · Rucola · Semidried Tomater", price: 90, category: "pizza", ingredients: ["Tomat", "Ost", "Rucola", "Semidried Tomater"], image: "https://images.unsplash.com/photo-1555072956-7758afb20e8f?q=80&w=600&auto=format&fit=crop" },
  ...
  // PASTA
  { id: 30, name: "30. Lasagne", price: 80, category: "pasta", ingredients: ["Lasagne"], image: "https://images.unsplash.com/photo-1619895092538-128341789043?q=80&w=600&auto=format&fit=crop" },
  { id: 31, name: "31. Dagens Pasta", price: 80, category: "pasta", ingredients: ["2 slags hver dag"], image: "https://images.unsplash.com/photo-1473093295043-cdd812d0e601?q=80&w=600&auto=format&fit=crop" },
  ...
  { id: 33, name: "33. Tomat · Ost · Salami · Salat · Lys Dressing", price: 70, category: "sandwich", ingredients: ["Brød", "Tomat", "Ost", "Salami", "Salat", "Lys Dressing"], image: "https://images.unsplash.com/photo-1525351484163-7529414344d8?q=80&w=600&auto=format&fit=crop" },
  { id: 34, name: "34. Tomat · Ost · Tun · Salat · Lys Dressing", price: 70, category: "sandwich", ingredients: ["Brød", "Tomat", "Ost", "Tun", "Salat", "Lys Dressing"], image: "https://images.unsplash.com/photo-1619860860774-1e2e17343432?q=80&w=600&auto=format&fit=crop" },
  ...
  { id: 36, name: "36. Tomat · Ost · Salat · Parmaskinke · Pesto", price: 75, category: "sandwich", ingredients: ["Brød", "Tomat", "Ost", "Salat", "Parmaskinke", "Pesto"], image: "https://images.unsplash.com/photo-1554433607-66b5efe9d304?q=80&w=600&auto=format&fit=crop" },
  { id: 37, name: "37. Tomat · Ost · Bresaola · Salat · Pesto", price: 75, category: "sandwich", ingredients: ["Brød", "Tomat", "Ost", "Bresaola", "Salat", "Pesto"], image: "https://images.unsplash.com/photo-1619860860774-1e2e17343432?q=80&w=600&auto=format&fit=crop" },
  { id: 38, name: "38. Tomat · Ost · Kalkun · Salat · Pesto", price: 70, category: "sandwich", ingredients: ["Brød", "Tomat", "Ost", "Kalkun", "Salat", "Pesto"], image: "https://images.unsplash.com/photo-1528735602780-2552fd46c7af?q=80&w=600&auto=format&fit=crop" },
  ...
  { id: 45, name: "45. Blandet Salat", price: 55, category: "salat", ingredients: ["Blandet Salat", "Dressing"], image: "https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?q=80&w=600&auto=format&fit=crop" },
]
...
window.openCustom = (id) => {
  ...
  document.querySelector('#custom-item-name').innerText = `Tilpas ${item.name}`
  document.querySelector('#custom-item-desc').innerText = item.ingredients.join(' · ')
...
const renderIngredients = () => {
  ...
  currentCustomItem.ingredients.forEach(ing => {
    const isRemoved = currentCustomItem.removed.includes(ing)
    html += `
      <button class="ingredient-btn ${isRemoved ? 'removed' : ''}" onclick="toggleIngredient('${ing}', 'remove')">
        ${ing} <span>${isRemoved ? '+' : '−'}</span>
      </button>
    `
  })

  EXTRA_INGREDIENTS.forEach(ing => {
    const isAdded = currentCustomItem.added.includes(ing)
    html += `
      <button class="ingredient-btn ${isAdded ? 'added' : ''}" onclick="toggleIngredient('${ing}', 'add')">
        ${ing} <span>${isAdded ? '−' : '+'}</span>
      </button>
    `
  })
...
window.toggleIngredient = (ing, action) => {
  if (action === 'remove') {
    if (currentCustomItem.removed.includes(ing)) {
      currentCustomItem.removed = currentCustomItem.removed.filter(i => i !== ing)
    } else {
      currentCustomItem.removed.push(ing)
    }
  } else {
    if (currentCustomItem.added.includes(ing)) {
      currentCustomItem.added = currentCustomItem.added.filter(i => i !== ing)
    } else {
      currentCustomItem.added.push(ing)
    }
  }
  renderIngredients()
}
...
window.confirmCustom = () => {
  ...
  updateCartUI()
  closeCustom()
  showToast(`${currentCustomItem.name} tilføjet!`)
}
...
window.toggleCart = () => {
  ...
  if (isVisible) {
    ...
    document.querySelector('#final-checkout-btns').style.display = 'none'
  } else {
    renderCart()
  }
}
...
window.showCheckoutFields = () => {
  ...
  document.querySelector('#final-checkout-btns').style.display = 'grid'
}

window.changeQty = (uniqueId, delta) => {
...
const renderCart = () => {
  ...
  if (cart.length === 0) {
    list.innerHTML = `<p style="text-align: center; color: var(--text-muted);">Din kurv er tom...</p>`
    totalEl.innerText = `0 DKK`
    return
  }

  list.innerHTML = cart.map(item => {
    let customInfo = ''
    if (item.removed.length > 0) customInfo += `<span class="customization-badge">Uden: ${item.removed.join(', ')}</span>`
    if (item.added.length > 0) customInfo += `<span class="customization-badge">Ekstra: ${item.added.join(', ')}</span>`

    return `
      <div class="cart-item" style="flex-direction: column; align-items: flex-start; gap: 4px;">
        ...
        ${customInfo ? `<div style="display: flex; gap: 4px; flex-wrap: wrap;">${customInfo}</div>` : ''}
      </div>
    `
  }).join('')

  const total = cart.reduce((acc, curr) => acc + (curr.price * curr.qty), 0)
  totalEl.innerText = `${total} DKK`
}
...
window.checkout = (method) => {
  ...
  if (!name || !address) return alert('Venligst udfyld navn og adresse!')

  let message = `Hej Pronto Næstved! Mit navn er ${name}.\n`
  message += `Bestilling til: ${address}\n\n`
  message += `Jeg vil gerne bestille:\n`

  cart.forEach(item => {
    message += `- ${item.qty}x ${item.name}\n`
    if (item.removed.length > 0) message += `  (Uden: ${item.removed.join(', ')})\n`
    if (item.added.length > 0) message += `  (Ekstra: ${item.added.join(', ')})\n`
  })
  ...
  grid.innerHTML = filteredItems.map((item, index) => {
    ...
    <div class="glass-panel pizza-card" style="animation-delay: ${index * 0.05}s">
      ...
      <div class="price-row" style="margin-top: 1.5rem; padding-top: 1.5rem;">
        ...
        <button class="btn-primary" onclick="openCustom(${item.id})" style="padding: 12px 24px; font-size: 0.95rem; border-radius: 12px; display: flex; align-items: center; gap: 8px;">
          Tilføj 
          <span style="font-size: 1.5rem; font-weight: 300; line-height: 0;">+</span>
        </button>
      </div>
    </div>
  `}).join('')
